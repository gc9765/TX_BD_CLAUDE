 ...
 */
curl_malloc_callback Curl_cmalloc = (curl_malloc_callback)custom_malloc_psram;
curl_free_callback Curl_cfree = (curl_free_callback)custom_free_psram;
curl_realloc_callback Curl_crealloc = (curl_realloc_callback)custom_realloc_psram;
curl_strdup_callback Curl_cstrdup = (curl_strdup_callback)system_strdup;
curl_calloc_callback Curl_ccalloc = (curl_calloc_callback)custom_calloc_psram;
...
static CURLcode global_init(long flags, bool memoryfuncs)
{
  ...
  if(memoryfuncs) {
    ...
    Curl_cmalloc = (curl_malloc_callback)custom_malloc_psram;
    Curl_cfree = (curl_free_callback)custom_free_psram;
    Curl_crealloc = (curl_realloc_callback)custom_realloc_psram;
    Curl_cstrdup = (curl_strdup_callback)system_strdup;
    Curl_ccalloc = (curl_calloc_callback)custom_calloc_psram;
#if defined(_WIN32) && defined(UNICODE)
