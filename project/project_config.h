...
#define CUSTOM_PSRAM_SIZE   1024*1024 * 3 / 2 //500*1024
#define PSRAM_HEAP			//如果需要psram当作heap,需要打开这个宏
#define PSRAM_TASK_STACK   1
#define MALLOC_IN_PSRAM
...
#define CUSTOM_PSRAM_SIZE   800*1024//500*1024
#define PSRAM_HEAP			//如果需要psram当作heap,需要打开这个宏
...
//#define  LLM_TTI_TEST         // tti test
#define  IMAGE_GENERATION_DEMO
...
#define USB_HOST_EN                     0
#define MACBUS_USB
#define USB_DEVICE_MASS_OR_UVC
#define USBDISK                         0

/*=========== RTT USB架构宏定义 ==========*/
#define RTT_USB_EN                      0
#define USB_DETECT_EN					0
#define CUSTOM_SIZE                     (17*1024)
...
#define OPENDML_EN                      1  // OpenDML 是 AVI 文件格式的一种扩展
#define UART_FLY_CTRL_EN                0
#define PWM_EN                          0
#define KEY_MODULE_EN					1
#define FLASHDISK_EN					0
#define MP3_EN                          1
#define AMR_EN                          0  //AMR音频编解码模块
#define NET_PAIR                        0
#define PRINTER_EN						0
...
#define WIFI_RTS_THRESHOLD              1600
#define WIFI_RTS_MAX_RETRY              2
#define WIFI_TX_MAX_RETRY               15
#define WIFI_TX_MAX_POWER               7
#define WIFI_TX_SUPP_RATE               0x0FFFFF
#define WIFI_MAX_STA_CNT                8
#define WIFI_MULICAST_RETRY             0
#define WIFI_ACS_CHAN_LISTS             0x03FF
#define WIFI_ACS_SCAN_TIME              150
#define WIFI_MAX_PS_CNT                 30
#define CHANNEL_DEFAULT                 0
#define SSID_DEFAULT                    "hugeic_cs"
#define WIFI_TX_DUTY_CYCLE              80
#define WIFI_SSID_FILTER_EN             0
#define WIFI_PREVENT_PS_MODE_EN         1
#define IP_ADDR_DEFAULT                 0x0101A8C0
#define NET_MASK_DEFAULT                0x00FFFFFF
#define GW_IP_DEFAULT                   0x0101A8C0
#define DHCP_START_IP_DEFAULT           0x6401A8C0
#define DHCP_END_IP_DEFAULT             0xFE01A8C0

///////////////串口配置////////////
/* [修改] UART0_TX 从 PA_10 迁移到 PC_6，释放 PA_10 作为 DVP_EN (摄像头使能)
 * 参照需求 §4.2: PA10=DVP_EN, PC6=UART0_TX */
#define PIN_UART0_TX                    PC_6
#define PIN_UART0_RX                    255
#define ATCMD_UARTDEV                   HG_UART0_DEVID
...
/* 禁用 PDM 麦克风 (PA3→ADKey, PA4→SD_CMD) */
#define PIN_PDM_MCLK                    255
#define PIN_PDM_DATA                    255

/* 禁用 I2S (PA7→LCD TE, PA8→LCD RS, PA5→SD_CLK) */
#define PIN_IIS0_MCLK                   255
#define PIN_IIS0_BCLK                   255
#define PIN_IIS0_WCLK                   255
#define PIN_IIS0_DATA                   255

/* ========== LCD 配置 (ST7789V MCU 8080 8-bit) ========== */
#define LVGL_STREAM_ENABLE              1
#define LCD_ST7789V_MCU565_EN           1

#define PIN_LCD_RESET                   PA_11
#define PIN_LCD_BL                      PA_12   /* LCD backlight (LEDA) */

/* LCD 控制引脚 (MCU 8080 接口) */
#define DOTCLK_RWR                      PA_13   // LCD WR (MCU 8080 写信号)
#define DE_ERD                          255     // LCD RD (不使用)
#define VS_CS                           PA_14   // LCD CS
#define HS_DC                           PA_8    // LCD RS / D/CX
#define LCD_TE                          PA_7    // LCD TE (帧同步)

/* LCD 数据引脚 D0~D7 = PC8~PC15 */
#define LCD_D0  PC_8
#define LCD_D1  PC_9
#define LCD_D2  PC_10
#define LCD_D3  PC_11
...
/* ========== SD 卡 (SDIO: CLK=PA5, CMD=PA4, DAT0=PA6) ========== */
#define PIN_SDH_CLK                     PA_5
#define PIN_SDH_CMD                     PA_4
#define PIN_SDH_DAT0                    PA_6
#define PIN_SDH_DAT1                    255
#define PIN_SDH_DAT2                    255
#define PIN_SDH_DAT3                    255

#define SDH_I2C2_REUSE                  0

/* ========== I2C (摄像头 I2C: SCL=PC2, SDA=PC3) ========== */
#define PIN_IIC2_SCL                    PC_2
#define PIN_IIC2_SDA                    PC_3
...
#define PIN_DVP_RESET                   255
#define PIN_DVP_PDN                     PA_9   /* 摄像头 PWDN 引脚: HIGH=休眠, LOW=工作 */

/* ========== JPEG 缓冲区 ========== */
#define JPG_HEAD_RESERVER               0
#define JPG_BUF_LEN                     1308
#define JPG_NODE                        40
#define JPG_TAIL_RESERVER               0

#define JPG0_HEAD_RESERVER              0
#define JPG0_BUF_LEN                    1400
#define JPG0_NODE                       40
#define JPG0_TAIL_RESERVER              0

#define JPG1_HEAD_RESERVER              0
#define JPG1_BUF_LEN                    1308
#define JPG1_NODE                       40
#define JPG1_TAIL_RESERVER              0

/* ========== 内存配置 ========== */
#define CUSTOM_PSRAM_SIZE               1024*1024*3/2
#define PSRAM_HEAP						60*1024
...
/* ========== 其他 ========== */
#define  WIFI_RX_BUFF_SIZE              (7*1024)
#define  SKB_POOL_SIZE                  (8*1024)
...
/* [新增] 启用 SNTP 网络时间同步，用于状态栏时间显示 */
#define SYS_APP_SNTP                    1
